...
A Temporal Vision Transformer processes sequences of movements to recognize gestures over time
A phrase assembly component converts recognized signs into continuous text subtitles

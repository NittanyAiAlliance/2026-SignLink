#!/usr/bin/env python3
"""
SignLink Preview - MS-ASL 10 Words Edition
Test your trained model locally (no virtual camera needed).
...
def main():
    print("=" * 70)
    print("SIGNLINK PREVIEW - 10 Word Edition")
    print("=" * 70)
    ...
    print()
    print("Border colors:")
    print("  GRAY  = Waiting for hands")
    print("  GREEN = Collecting gesture")
    print("  BLUE  = Showing prediction")
    print("=" * 70 + "\n")
    ...
    try:
        while True:
            ...
            # Show preview window
            cv2.imshow("SignLink MS-ASL Preview (Press Q to quit)", frame)

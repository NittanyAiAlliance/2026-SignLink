#!/usr/bin/env python3
"""
SignLink Virtual Camera - Body + Hands (NO PREVIEW)

Runs in background for video calls without a preview window.
...
def main():
    print("=" * 70)
    print("SIGNLINK VIRTUAL CAMERA - Body + Hands (NO PREVIEW)")
    print("=" * 70)
    ...
    try:
        ...
        print()
        print("=" * 70)
        print("NO PREVIEW MODE - Running in background")
        print("=" * 70)
        ...
        print()
        print("Select this camera in your video call app:")
    ...
    try:
            ...
            while True:
                ...
                if current_state == "WAITING":
                    if hands_detected:
                        ...
                        display_conf = None
                        hold_frames = 0
                        print(f"Gesture {gesture_count} started")
                ...
                # INFERENCE
                # ==================================================
                if current_state == "COLLECTING" and model is not None:
        ...
        print(f"\nStopping... Total gestures: {gesture_count}")
    finally:
        cap.release()
